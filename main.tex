...
\section*{\numbox{1}\bfseries\textcolor{titlecol}{\sffamily Personal information}}
              \begin{tabular}{rlcrl}
	               ...
	               \\[.5mm]
	               \small\textsc{Webpage}~~~ & \small \href{https://sites.google.com/view/raghebrahmaniani/home}{{@RaghebRahmaniani }}
	               \\[.5mm]
	               \small\textsc{Scholar} ~~~ & \small  \small\href{https://scholar.google.com/citations?user=3V2o0Q0AAAAJ\&hl=en}{@RaghebRahmaniani}
	               \\[.5mm]
	               \small\textsc{Github}~~~ & \small \small\href{https://github.com/Ragheb2464}{\texttt{$@$Ragheb2464}}
	               \\[.5mm]
...
\section*{\numbox{2}\bfseries\textcolor{titlecol}{\sffamily Education}}
        \begin{tabular}{lp{5.5in}}
	            ...
	            & $\triangleright$ {\small\textbf{Topics}}: Stochastic Programming, Integer Programming, Decompositions, Algorithms.\\
	            ...
	            & The coursework was intensely  focused on the \textit{Operations Research} methodologies and my research was focused on developing novel high-performance algorithms for general MILP problems.\\[.5mm]
	            ...
	            & $\triangleright$ {\small\textbf{Applications}}: Transportation and Logistics.\\[4mm]
	            %MSc
				...
				& The coursework had a strong focus on Math, Project Management, Technology Management,  with additional courses in Mechanics. \\[.5mm]
				...
				& $\triangleright$ {\small\textbf{Applications}}: Airline Scheduling, Transportation.
        \end{tabular}
%End of Education
...
\vspace{5pt}
			\begin{tabular}{p{1in}p{5.55in}}
						...
						\textsc{2018--now}\newline\raisebox{3mm}{\includegraphics[width=2.5cm]{static/logos/optimizedlogo.png}} & 
												Full Time Applied Research Engineer at Optimized Markets, Inc. 
												I am responsible for designing, implementing, and validating  optimization-based algorithms, software design and development and testing, configuring for delivery through a third party cloud service,  and monitoring and managing pilot projects.	I also interact with the customers regarding design requirements as well as providing them help and technical support. My duties  also include conducting research, publishing papers, and presenting at conferences.\\[2mm]
						...
						\textsc{2017--2018}\vspace{1mm}\newline\raisebox{-3pt}{\includegraphics[width=2.56cm]{static/logos/ISYE}} &
												...
												I was responsible of re-designing, improving, testing, and extending an optimization  package for multi-stage stochastic integer problems. I was also responsible for using the solver on new problems and provide analytical insights. \\[1mm]
						
						\textsc{2012--2013}\vspace{1mm}\newline \includegraphics[width=2.75cm]{static/logos/UoK} &
												Teacher Assistant at Kurdistan University.
												\begin{enumerate}
													\item Industrial Plants Layout Planning: I was responsible of  holding problem solving sessions, giving and correcting assignments, taking quizzes (short exams);
													\item Engineering Economics: I was responsible of holding problem solving sessions, giving and correcting assignments, taking the midterm and instructing the course for 2 sessions due to travel-absence of the professor.
												\end{enumerate}
											 \\[1mm]
						\textsc{2012}\vspace{1mm}\newline \includegraphics[width=1.5cm]{static/logos/TPOI} &
										...
										I was responsible of providing finical appraisal reports using COMFAR software, analysis the results, and write reports. \\[1mm]
						...
						\textsc{2011--2012}\vspace{1mm}\newline \includegraphics[width=2.75cm]{static/logos/Mobien} &
											...
											I was responsible of gathering, cleaning, and analyzing   stock  data using statistical and neural network software. \\[1mm]
						...
						\textsc{2010--2012}\vspace{1mm}\newline \includegraphics[width=1.5cm]{static/logos/IUST} &
										...
										I was helping undergrade students with their academic curricula by providing advices on the courses according to their interests and goals. \\[1mm]
										
						\textsc{2010}\vspace{1mm}\newline \includegraphics[width=1.95cm]{static/logos/ABSAL} &
										Summer Intern  at Absal Inc. 
										I was responsible of detecting the bottlenecks on the Air Conditioning assembly  line and propose alternative  layouts in order to maximize the daily outputs. \\[1mm]
						
						\textsc{2009} \vspace{1mm} \newline \includegraphics[width=1.4cm]{static/logos/RAI} & 
										I was involved in a project entitled \textit{Sources of Delay in Iranian Railway Transportation System: Investigation, Identification, and Solution Strategies} for 4 months. My responsibilities were to write an up-to-date  report and a synthesis of rail freight transportation in the European countries and highlight the main differences with the current management system at Iran.  
...
\section*{\numbox{6}\bfseries\textcolor{titlecol}{\sffamily Honors and Awards}}
    ...
    \section*{\numbox{7}\bfseries\textcolor{titlecol}{\sffamily Graduate Coursework}}
			\begin{tabular}{p{0.1in}p{6.55in}}
				...
				\textsc{} & 
									Decision Making with Multiple Criteria,  Statistical Methods,  Advanced Engineering Economy,  Mathematical Programming,  Logistics and Transportation Network Design, Graph Theory,  Integer Programming,  Stochastic Optimization.\\[1mm]
...
\section*{\numbox{9}\bfseries\textcolor{titlecol}{\sffamily Software and Systems}}
        	\subsection*{\subsectionstyle{Programming Languages}}
		            \begin{tabular}{p{5in}p{5.55in}}
		                \textsc{C++17, Python, Ruby on Rails, JavaScript} & \\[.5mm]
		            \end{tabular}
        ...
        \subsection*{\subsectionstyle{Cloud Computing}}
   	  	...
   	  	\subsection*{\subsectionstyle{Optimization  APIs}}
			    \begin{tabular}{p{5in}p{5.55in}}
			    	\textsc{CPLEX, GUROBI, GAMS, BARON} & \\[.5mm]
			    \end{tabular}
		 \subsection*{\subsectionstyle{Parallelization Libraries }}
				\begin{tabular}{p{5in}p{5.55in}}
					\textsc{Message Passing Interface, Boost Threads, Protocol Buffers} & \\[.5mm]
				\end{tabular}

     	\subsection*{\subsectionstyle{Useful Libraries}}
				\begin{tabular}{p{5in}p{5.55in}}
					\textsc{DOCOPT,  SPDLOG, OPENPYXL, TikZ, OSI} & \\[.5mm]
				\end{tabular}

		\subsection*{\subsectionstyle{Writing and Presentation Tools}}
				\begin{tabular}{p{5in}p{5.55in}}
					\textsc{\LaTeX, Microsoft Office} & \\[.5mm]
				\end{tabular}

        \subsection*{\subsectionstyle{Development and tooling}}
        		\begin{tabular}{p{5in}p{5.55in}}
        			\textsc{Bash scripting, cmake, bazel, cpplint, clang-format, valgrind, gdb} & \\[.5mm]
        		\end{tabular}


\section*{\numbox{9}\bfseries\textcolor{titlecol}{\sffamily Developed Software}}
			\begin{tabular}{p{1.5in}p{5.55in}}
				\textsc{BCompose} &  Highly efficient general-purpose decomposition-based solver for MILPs written in C++.\\[.5mm]
				\textsc{SDDiP} & I collaborated on developing  this solver for multi-stage stochastic integer problems. \\[.5mm]
				\textsc{Linear TV Ad Scheduler} & This package optimizes the advertisements aired on TVs such that all the business rules are satisfied and the revenue is maximized. \\[.5mm]
				\textsc{Schedule Viewer} & This software allows the mangers to observe and manipulate the produced schedules in a very user-friendly framework.  \\[.5mm]
			\end{tabular}
