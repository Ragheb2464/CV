...
\section*{\numbox{7}\bfseries\textcolor{titlecol}{\sffamily Work Experience}}
			\begin{tabular}{p{1.2in}p{5.55in}}			
									\textsc{2022--now}\newline\raisebox{3mm}{\includegraphics[width=2.5cm]{static/logos/meta.png}} & 
												 Senior Machine Learning Specialist at the \textit{marketplace integrity}. I am responsible for designing and implementing multi-modal models to detect \textit{policy violations}  such as gun sales, healthcare, suggestive and low quality contents.  I delivered the model that ingests text, image and listing's metadata to detect and prevent sale of temporary liscence plates in the marketplace. The model was launched in production with  a precision of 97\%.   \\[3mm]
...
\begin{tabular}{p{1.2in}p{5.55in}}			 
	...
	\textsc{2013--2017}\newline\raisebox{3mm}{\includegraphics[width=2cm]{static/logos/cirrelt}} & 
	...
	\textsc{2012--2013}\vspace{.1mm}\newline \includegraphics[width=2.5cm]{static/logos/UoK} &
