...
\vspace{5pt}
			\begin{tabular}{p{1.2in}p{5.55in}}
									...
									\textsc{2020--now}\newline\raisebox{3mm}{\includegraphics[width=2.5cm]{static/logos/amazon.jpg}} & 
												Full Time Applied Research Scientist  at Amazon's Payment Acceptance and Experience Team. I work at Machine Learning Science group and I am responsible for designing, implementing, and validating  ML solutions to support a wide-range of Amazon's payment products.\\[3mm]
